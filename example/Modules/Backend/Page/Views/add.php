...
<div class="app-main__inner">
                  ...
                  <div class="page-title-actions">
                        <nav class="" aria-label="breadcrumb">
                              <ol class="breadcrumb">
                                    ...
                                    <li class="active breadcrumb-item" aria-current="page">Tambah Halaman</li>
                              </ol>
                        </nav>
                  </div>
            </div>
      ...
      <div class="main-card mb-3 card">
            <div class="card-header">
                  <i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Form Tambah Halaman
            </div>
            <div class="card-body">
                  <div id="infoMessage"><?= $message ?? ''; ?></div>
                  <?= get_message('message'); ?>
                  <form id="frm_create_group" class="col-md-12 mx-auto" method="post" action="<?= base_url('page/create'); ?>">
                        <div class="form-row">
                              <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                                    <div class="form-group">
                                          ...
                                          <div>
                                                <input type="text" class="form-control" id="slug" name="slug" placeholder="" value="<?= set_value('slug'); ?>" readonly />
                                          </div>
                                    </div>
                              </div>
                        </div>
                        <div class="form-group">
                              ...
                              <div>
                                    <textarea id="content" name="content" placeholder="Uraian Halaman" rows="1" class="form-control autosize-input"><?= set_value('content'); ?></textarea>
                              </div>
                        </div>
                        <div class="form-row">
                              <div class="col-md-12">
                        ...
                        <div class="form-group">
                              ...
                              <div>
                                    <textarea id="description" name="description" placeholder="Deskripsi" rows="2" class="form-control autosize-input"><?= set_value('description'); ?></textarea>
                              </div>
                        </div>
                        <div class="form-group">
