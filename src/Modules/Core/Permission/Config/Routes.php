...
$routes->group('permission', ['namespace' => 'App\Modules\Core\Permission\Controllers'], function ($subroutes) {
...
$routes->group('api/permission', ['namespace' => 'App\Modules\Core\Permission\Controllers\Api'], function ($subroutes) {
	/*** Route Update for Permission ***/
	$subroutes->add('detail/(:any)', 'Permission::detail/$1');
	$subroutes->add('edit/(:any)', 'Permission::edit/$1');
	$subroutes->add('create', 'Permission::create');
